    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    members = _a.sent();
                    mapped = members.map(function (m) {
                        var _a, _b;
                        return ({
                            id: m.id,
                            name: ((_a = m.user) === null || _a === void 0 ? void 0 : _a.name) || 'Unknown',
                            code: m.memberId || m.referralCode,
                            status: m.greenStatus,
                            directSales: ((_b = m._count) === null || _b === void 0 ? void 0 : _b.referralsGiven) || 0,
                            balance: 0,
                ...
                case 2:
                    err_1 = _a.sent();
                    console.error("QUERY CRASHED:", err_1);
                    return [3 /*break*/, 3];
