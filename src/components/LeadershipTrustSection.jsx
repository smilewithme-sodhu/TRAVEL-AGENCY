...
export const LeadershipTrustSection = () => {
  ...
  return (
    <section className="bg-[#F4F7FC] py-16 sm:py-24 px-4 sm:px-6 lg:px-8 border-b border-blue-100/80 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10 space-y-12 sm:space-y-16">
        ...
        <div className="bg-white rounded-3xl border border-blue-100 shadow-xl shadow-blue-900/5 overflow-hidden grid grid-cols-1 lg:grid-cols-12 transition-all duration-300">
          ...
          <div className="lg:col-span-5 bg-gradient-to-br from-slate-900 via-[#0A3161] to-[#1E3A8A] relative min-h-[420px] lg:min-h-full flex flex-col justify-end overflow-hidden">
            <img 
              ...
              onError={(e) => {
                // Fallback in case of path encoding or local image loading
          ...
          {/* Right Column: Complete Founder's Letter */}
          <div className="lg:col-span-7 p-6 sm:p-10 lg:p-12 flex flex-col justify-between space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-slate-700 text-sm sm:text-base leading-relaxed">
                <p>
                  I am Lisa, a woman from beautiful <strong>Sikkim</strong>, and the founder of <strong>Lisa Travels</strong>.
                </p>
                <p>
                ...
                <p>
                  With a Graduate background in <strong>Tourism & Hospitality</strong> and <strong>5 years of experience</strong> in the travel industry, I decided to turn my passion into a profession and create Lisa Travels.
                </p>

                {/* Vision Box */}
                <div className="p-4 sm:p-5 rounded-2xl bg-blue-50/70 border border-blue-100 my-4 space-y-2">
                  <p className="font-semibold text-[#0A3161] text-sm sm:text-base">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 py-1">
                  <div className="flex items-center gap-2.5 bg-slate-50 px-3.5 py-2.5 rounded-xl border border-slate-200/70 text-slate-800 text-sm font-medium">
                ...
                <p className="font-medium text-[#0A3161]">
            ...
            <div className="pt-6 border-t border-slate-100 space-y-6">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <div className="bg-blue-50/80 p-3 rounded-xl border border-blue-100 text-center">
                  ...
                  <div className="text-[11px] font-bold text-[#0A3161] leading-tight">Sikkim Woman Entrepreneur</div>
                </div>
                <div className="bg-blue-50/80 p-3 rounded-xl border border-blue-100 text-center">
                  <span className="text-lg block mb-0.5">🎓</span>
                  <div className="text-[11px] font-bold text-[#0A3161] leading-tight">Graduate in Tourism</div>
                </div>
                <div className="bg-blue-50/80 p-3 rounded-xl border border-blue-100 text-center">
                  <span className="text-lg block mb-0.5">⏳</span>
                  <div className="text-[11px] font-bold text-[#0A3161] leading-tight">5 Years of Experience</div>
                </div>
                <div className="bg-blue-50/80 p-3 rounded-xl border border-blue-100 text-center">
                  <span className="text-lg block mb-0.5">❤️</span>
                  <div className="text-[11px] font-bold text-[#0A3161] leading-tight">500+ Happy Customers</div>
                </div>
              </div>

              {/* Sign-off Box */}
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 bg-slate-50 p-4 sm:p-5 rounded-2xl border border-slate-200/60">
                <div className="space-y-1">
                  <p className="font-display font-bold text-[#0A3161] text-base sm:text-lg flex items-center gap-1.5">
                    <span>Welcome to Lisa Travels.</span>
                  </p>
                  <p className="text-xs sm:text-sm text-slate-600 font-medium">
                    Let’s create beautiful travel memories together! ✈️🌸
                  </p>
                  <p className="text-xs font-bold text-[#2563EB] pt-1">
                    Your Journey. Our Passion. Your Memories. ❤️
                  </p>
                </div>
                
                <div className="text-left sm:text-right shrink-0 border-l-2 sm:border-l-0 sm:border-r-0 border-[#2563EB] pl-3 sm:pl-0">
                  <div className="font-display font-extrabold text-[#0A3161] text-base flex items-center sm:justify-end gap-1">
                    <span>🌸 Lisa</span>
                  </div>
                  <div className="text-xs text-slate-500 font-semibold">Founder – Lisa Travels</div>
                  <div className="text-[11px] text-slate-400">Sikkim, India</div>
                </div>
              </div>
        ...
        <div className="bg-white rounded-3xl border border-blue-100 shadow-lg shadow-blue-900/5 p-6 sm:p-8 lg:p-10 transition-all duration-300">
          <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8">
            
            {/* Sunil Sharma Photo */}
            <div className="relative shrink-0">
              <div className="w-28 h-28 sm:w-36 sm:h-36 rounded-2xl overflow-hidden border-2 border-blue-200 shadow-md relative bg-slate-100">
                <img 
            ...
            <div className="flex-1 space-y-4 text-center md:text-left">
              <div className="space-y-1">
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-100 text-slate-700 font-mono text-xs font-semibold">
                  <ShieldCheck size={13} className="text-[#2563EB]" />
                  <span>Operations & Ground Safety</span>
                </div>
                <h3 className="font-display font-bold text-xl sm:text-2xl text-[#0A3161]">
              ...
              {/* Highlights */}
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 sm:gap-6 pt-2 text-xs font-semibold text-slate-600">
                <span className="flex items-center gap-1.5">
                  <CheckCircle2 size={15} className="text-[#2563EB]" />
                  24/7 Concierge & Ground Coordination
                </span>
                <span className="flex items-center gap-1.5">
                  <CheckCircle2 size={15} className="text-[#2563EB]" />
                  Verified Drivers & Seamless Logistics
                </span>
                <span className="flex items-center gap-1.5">
                  <CheckCircle2 size={15} className="text-[#2563EB]" />
            ...
            <div className="shrink-0 w-full md:w-auto pt-2 md:pt-0">
              <button
                ...
                className="w-full md:w-auto inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl bg-[#0A3161] hover:bg-[#072447] text-white font-bold text-xs uppercase tracking-wider transition-all shadow-md hover:shadow-lg cursor-pointer"
              >
                <PhoneCall size={15} className="text-[#FACC15]" />
