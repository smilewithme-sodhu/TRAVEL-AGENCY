      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-3">
          <div className="inline-flex items-center gap-1.5 font-mono text-[10px] sm:text-xs uppercase tracking-widest text-[#0284C7] font-bold">
            <span>THE GUMNU JUM METHOD</span>
          </div>
          ...
          <p className="text-slate-500 text-xs sm:text-sm leading-relaxed font-medium">
            Affordable, flexible, and customized itineraries designed around your dreams and budget.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
          {HOW_IT_WORKS_STEPS.map((step, idx) => {
            ...
            return (
              <div
                key={idx}
                className="bg-[#F8FAFC] rounded-3xl p-6 sm:p-8 border border-sky-100 shadow-xs flex flex-col justify-between space-y-6 hover:shadow-md hover:border-sky-200 transition-all"
              >
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <div className="w-12 h-12 rounded-2xl bg-white text-[#0284C7] border border-sky-100 flex items-center justify-center font-bold shadow-sm">
                      <Icon size={22} />
                    </div>
                    <span className="font-mono text-2xl font-black text-sky-200">
                      {step.stepNumber}
                    </span>
                  </div>

                  <div className="font-mono text-xs uppercase font-bold text-[#F97316] tracking-wider mb-1">
                    STAGE :: {step.code}
                  </div>
        ...
        <div className="text-center pt-2">
          <button
            onClick={() => openWhatsApp(null, "Hello Gumnu JUM by Lisa Travels, I would like to consult on planning a customized holiday itinerary.")}
