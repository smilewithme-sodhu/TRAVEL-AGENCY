...
export const TravelerGalleryPage = () => {
  ...
  // ⚡ Bolt Optimization: Memoize filtered photos to prevent unnecessary
  // O(N) array filtering on every component re-render (e.g., when modal state changes)
  // Expected Impact: Reduces re-renders and computation time for large photo galleries
