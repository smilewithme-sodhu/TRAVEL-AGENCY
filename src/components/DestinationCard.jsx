...
const DestinationImageBanner = ({ destination, isHovered, isSaved, toggleWishlist }) => (
...
const DestinationContentBody = ({ destination }) => (
  <div>
...
const DestinationFooter = ({ destination, openInquiryModal, openWhatsAppInquiry }) => (
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '20px', flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
        <DestinationContentBody destination={destination} />
        <DestinationFooter
          destination={destination}
